...
<section class="panel panel-featured panel-featured-primary">
	...
	<header class="panel-heading">
		<strong class="text-uppercase">Lista de estudiantes</strong>
	</header>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo base_url();?>index.php?teacher/student_marksheet/<?php echo $row['student_id'];?>" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('mark_sheet');?>">
                                    <i class="fa fa-signal"></i>
                                    </a>

									<!-- STUDENT PROFILE LINK -->
									<a href="#" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('profile');?>" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_student_profile/<?php echo $row['student_id'];?>');">
                                    <i class="fa fa-user"></i>
                                    </a>

									<!-- STUDENT EDITING LINK -->
									<a href="#" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('edit');?>" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_student_edit/<?php echo $row['student_id'];?>');">
...
<script type="text/javascript">
	function class_section( class_id ) {
		window.location.href = '<?php echo base_url(); ?>index.php?teacher/student_information/' + class_id;
	}
</script>