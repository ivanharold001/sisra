...
<section class="panel">
	<div class="panel-body">
			...
			<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						...
						<select data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" name="section_id" id="section_selector_holder" class="form-control mb-sm">
							<?php
		...
		<style>
			...
			td {
				border: 1px solid #864141  !important;
