		...
		<section class="panel">
			<div class="panel-body">
				<div class="thumb-info mb-md">
					<img src="<?php echo $this->crud_model->get_image_url('teacher' , $row['teacher_id']);?>" class="rounded img-responsive">
		...
		<div class="tabs">
			...
			<div class="tab-content">
				...
				<div id="edit" class="tab-pane active">
					...
					<?php echo form_open(base_url() . 'index.php?teacher/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<select name="sex" class="form-control" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity">
								  ...
								  <option value="female"<?php if($row['sex'] == 'female')echo 'selected';?>><?php echo get_phrase('Femenino');?></option>
							  </select>
							</div>
						</div>
					...
					<?php echo form_open(base_url() . 'index.php?teacher/manage_profile/change_password' , array('class' => 'form-horizontal form-bordered validate','target'=>'_top'));?>
					<h4 class="mb-xlg">
