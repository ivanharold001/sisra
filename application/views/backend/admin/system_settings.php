	...
	<div class="col-md-6">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Texto de pie de página</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" name="footer_text" value="<?php echo $this->db->get_where('settings', array('type' => 'footer_text'))->row()->description; ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select name="running_year" class="form-control" data-plugin-selectTwo data-width="100%" data-plugin-options='{ "minimumResultsForSearch": -1 }'>
							...
							<?php for ($i = 0; $i < 10; $i++) : ?>
								<option value="<?php echo (2017 + $i); ?>-<?php echo (2017 + $i + 1); ?>" <?php if ($running_year == (2017 + $i) . '-' . (2017 + $i + 1)) echo 'selected'; ?>>
			...
			<!-- Boton Guardar Ajustes del sistema -->
	...
	<div class="col-md-6">
		...
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="row">
						<label class="col-xs-12 control-label" for="zoomcontrol">Color de fondo</label>
						<div class="col-xs-12">
				...
				<div class="form-group">
					<div class="row">
						<label class="col-xs-12 control-label" for="zoomcontrol">Estilo de bordes</label>
						<div class="col-xs-12">
							<select name="borders_style" class="form-control mb-md" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }'>
								<option value="true" <?php if ($borders == 'true') echo 'selected'; ?>>Redondeado</option>
								<option value="false" <?php if ($borders == 'false') echo 'selected'; ?>>Cuadrado</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div id="hidden-on-dark">
					...
					<div class="form-group mb-md">
						<div class="row">
							<label class="col-xs-12 control-label" for="zoomcontrol">Cabecera Color</label>
							<div class="col-xs-12">
					...
					<div class="form-group  mb-md">
						<div class="row">
							<label class="col-xs-12 control-label" for="zoomcontrol">Color de la barra lateral</label>
							<div class="col-xs-12">
				...
				<div class="form-group">
					<div class="row">
						<label class="col-xs-12 control-label" for="zoomcontrol">Tamaño de la barra lateral</label>
						<div class="col-xs-12">
							<select name="sidebar_size" class="form-control mb-md" data-plugin-selectTwo data-width="100%" data-plugin-options='{ "minimumResultsForSearch": -1 }'>
								<option value="sidebar-left-xs" <?php if ($sidebar_size == 'sidebar-left-xs') echo 'selected'; ?>>Pequeño</option>
								<option value="sidebar-left-sm" <?php if ($sidebar_size == 'sidebar-left-sm') echo 'selected'; ?>>Mediano</option>
